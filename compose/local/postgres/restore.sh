...
echo "deleting old database $POSTGRES_DB_NAME"
if dropdb -h $POSTGRES_HOST -U $POSTGRES_USER $POSTGRES_DB_NAME
then echo "deleted $POSTGRES_USER database"
else echo "database $POSTGRES_USER does not exist, continue"
fi

# create a new database
echo "creating new database $POSTGRES_DB_NAME"
createdb -h $POSTGRES_HOST -U $POSTGRES_USER $POSTGRES_DB_NAME -O $POSTGRES_DB_NAME

# restore the database
echo "restoring database $POSTGRES_DB_NAME"
